...
# -*- coding: utf-8 -*-
#
# airflow_pm2 documentation build configuration file, created by
...
# built documents.
#
_version_py = os.path.join("..", "airflow_pm2", "_version.py")
version_ns = {}
...
htmlhelp_basename = "airflow_pm2doc"
...
latex_documents = [
    (master_doc, "airflow_pm2.tex", "airflow_pm2 Documentation", "Tim Paine", "manual"),
]
...
man_pages = [(master_doc, "airflow_pm2", "airflow_pm2 Documentation", [author], 1)]
...
def run_apidoc(_):
    ...
    airflow_pm2_dir = os.path.abspath(
        os.path.join(os.path.dirname(__file__), "..", "airflow_pm2")
    )
    ...
    subprocess.check_call(
        [cmd_path, "-E", "-M", "-o", out_dir, airflow_pm2_dir, "--force"]
    )
