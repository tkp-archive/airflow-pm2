...
latex_documents = [
    (master_doc, 'airflow_pm2.tex', 'airflow_pm2 Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'airflow_pm2', 'airflow_pm2 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'airflow_pm2', 'airflow_pm2 Documentation',
     author, 'airflow_pm2', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    airflow_pm2_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'airflow_pm2'))
